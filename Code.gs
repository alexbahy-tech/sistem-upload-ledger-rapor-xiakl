 ...
 */
const CONFIG = {
  SHEET_ID: "1-KFEsgBI3nxR_IRakim9k9qCWkhoIssAu72OlydQmH4", // ID Spreadsheet Database
  SHEET_NAME: "Sheet1",                                     // Nama Sheet
  PARENT_FOLDER_ID: "19ZDbOkbFgsIHIRwyVqa3nzCd3YNvzSNO",    // ID Folder Induk Siswa
  LEDGER_FOLDER_ID: "13XdDNhp0Iccll0lcNW4_n_JLfw32v1KL"     // ID Folder Ledger
};
